...
<head>
  ...
  <style>
    ...
    .portal-primary {display:grid;gap:18px;align-content:start;justify-items:start;}
    .portal-secondary {display:grid;gap:16px;align-content:start;justify-items:start;}
    ...
    .portal-map-card {background:rgba(255,255,255,0.92);border:1px solid rgba(148,163,184,0.26);border-radius:18px;box-shadow:0 16px 28px rgba(15,23,42,0.1);padding:16px 18px;display:flex;flex-direction:column;gap:12px;width:100%;max-width:540px;}
    .portal-map-heading {margin:0;font-size:1.05rem;font-weight:700;color:#0b1736;}
    .portal-map-image {flex:0;width:100%;display:block;border-radius:14px;box-shadow:0 12px 24px rgba(15,23,42,0.12);border:1px solid rgba(148,163,184,0.28);object-fit:contain;background:#e2e8f0;max-height:320px;}
